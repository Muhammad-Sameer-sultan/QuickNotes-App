...
const Alert = (props) => {
    const capitalize = (word) => {
      ...
      let image;
      switch (props.alert.color) {
        case "success":
            image="check-circle-fill";
            break;
        case "warning":
            image="exclamation-triangle-fill";
            break;
        case "danger":
            image="exclamation-triangle-fill";
            break;
  ...
  <symbol id="exclamation-triangle-fill" viewBox="0 0 16 16">
    ...
    <div className={`alert alert-${props.alert.color} d-flex align-items-center p-2`} role="alert">
  <svg className="bi flex-shrink-0 me-2" role="img" style={{height:"2rem",width:"2rem"}}ria-label="Info:"> <use xlinkHref={`#${image}`} /></svg>
  <div>
